      ...
      <div className="header-right">
        ...
        {showAdminControls && (
          <div id="admin-header-controls" className="admin-header-controls">
            ...
            <button className="btn-settings" onClick={() => setShowSettings(true)} title="Settings" style={{background:'none',border:'none',cursor:'pointer',fontSize:'16px',padding:'4px'}}>⚙️</button>
